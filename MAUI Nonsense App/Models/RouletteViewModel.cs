...
public class RouletteViewModel : INotifyPropertyChanged
{
    ...
    public async Task SpinBall(GraphicsView canvas)
    {
        ...
        // Ball will stop at the center of the selected slice
        float finalAngle = slice * resultIndex + slice / 2;
        ...
        while (stopwatch.ElapsedMilliseconds < duration)
        {
            ...
            float eased = 1f - (float)Math.Pow(1 - t, 3); // cubic ease out
...
public static class RouletteData
{
    ...
    {
        new("0", Colors.Green),
        new("28", Colors.Black), new("9", Colors.Red), new("26", Colors.Black), new("30", Colors.Red),
        new("11", Colors.Black), new("7", Colors.Red), new("20", Colors.Black), new("32", Colors.Red),
        new("17", Colors.Black), new("5", Colors.Red), new("22", Colors.Black), new("34", Colors.Red),
        new("15", Colors.Black), new("3", Colors.Red), new("24", Colors.Black), new("36", Colors.Red),
        new("13", Colors.Black), new("1", Colors.Red),

        new("00", Colors.Green),

        new("27", Colors.Red), new("10", Colors.Black), new("25", Colors.Red), new("29", Colors.Black),
        new("12", Colors.Red), new("8", Colors.Black), new("19", Colors.Red), new("31", Colors.Black),
        new("18", Colors.Red), new("6", Colors.Black), new("21", Colors.Red), new("33", Colors.Black),
        new("16", Colors.Red), new("4", Colors.Black), new("23", Colors.Red), new("35", Colors.Black),
        new("14", Colors.Red), new("2", Colors.Black)
    };
}
